...
export const ZONE_DEFINITIONS = [
    {
        ...
        bounds: { minX: 8, maxX: 18, minY: 15, maxY: 25 },
        color: '#4a5568',
    ...
    },
    {
        ...
        type: ZONE_TYPES.RESIDENTIAL,
        bounds: { minX: 5, maxX: 15, minY: 5, maxY: 12 },
        color: '#4a5568',
        backgroundColor: 'rgba(74, 85, 104, 0.1)',
        borderColor: 'rgba(74, 85, 104, 0.3)',
    ...
    },
    {
        ...
        type: ZONE_TYPES.COMMERCIAL,
        bounds: { minX: 2, maxX: 8, minY: 12, maxY: 20 },
        color: '#f59e0b',
        backgroundColor: 'rgba(245, 158, 11, 0.1)',
        borderColor: 'rgba(245, 158, 11, 0.3)',
    ...
    },
    {
        ...
        bounds: { minX: 20, maxX: 28, minY: 5, maxY: 12 },
        color: '#8b5cf6',
    ...
    },
    {
        ...
        bounds: { minX: 18, maxX: 25, minY: 12, maxY: 18 },
        color: '#10b981',
    ...
    },
    {
        ...
        bounds: { minX: 5, maxX: 10, minY: 20, maxY: 25 },
        color: '#22c55e',
    ...
    },
    {
        ...
        bounds: { minX: 25, maxX: 30, minY: 10, maxY: 20 },
        color: '#64748b',
