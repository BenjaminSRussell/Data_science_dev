class LocationBackgroundSystem {
    constructor(gameState) {
        this.gameState = gameState;
        this.backgrounds = {
            home: {
                apartment: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)',
                condo: 'linear-gradient(135deg, #4a5568 0%, #2d3748 100%)',
                house: 'linear-gradient(135deg, #2d3748 0%, #4a5568 100%)',
