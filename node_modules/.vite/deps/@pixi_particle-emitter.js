...
// node_modules/@pixi/utils/node_modules/earcut/src/earcut.js
var require_earcut = __commonJS({
  "node_modules/@pixi/utils/node_modules/earcut/src/earcut.js"(exports, module) {
    "use strict";
  ...
  "node_modules/punycode/punycode.js"(exports, module) {
    (function(root) {
      ...
      function decode(input) {
        var output = [], inputLength = input.length, out, i = 0, n = initialN, bias = initialBias, basic, j, index2, oldi, w2, k2, digit, t, baseMinusT;
...
var path = {
  ...
  rootname(path2) {
    ...
    if (path2.startsWith("/") ? root = "/" : root = this.getProtocol(path2), this.isUrl(path2)) {
      ...
      index2 !== -1 ? root = path2.slice(0, index2) : root = path2, root.endsWith("/") || (root += "/");
    }
    return root;
  },
  /**
...
var Runner = class {
  ...
  remove(item) {
    ...
    return index2 !== -1 && (this.ensureNonAliasedItems(), this.items.splice(index2, 1)), this;
  }
  /**
  ...
  static removeFromCache(baseTexture) {
    if (typeof baseTexture == "string") {
      ...
      if (baseTextureFromCache) {
        ...
        return index2 > -1 && baseTextureFromCache.textureCacheIds.splice(index2, 1), delete BaseTextureCache[baseTexture], baseTextureFromCache;
      }
...
var Buffer = class _Buffer {
  ...
  constructor(data, _static = true, index2 = false) {
    this.data = data || new Float32Array(1), this._glBuffers = {}, this._updateID = 0, this.index = index2, this.static = _static, this.id = UID++, this.disposeRunner = new Runner("disposeBuffer");
  }
...
`).map((line, index2) => `${index2}: ${line}`), shaderLog = gl.getShaderInfoLog(shader), splitShader = shaderLog.split(`
...
var Framebuffer = class {
  ...
  addColorTexture(index2 = 0, texture) {
    return this.colorTextures[index2] = texture || new BaseTexture(null, {
      scaleMode: SCALE_MODES.NEAREST,
      resolution: 1,
  ...
  static removeFromCache(texture) {
    if (typeof texture == "string") {
      ...
      if (textureFromCache) {
        ...
        return index2 > -1 && textureFromCache.textureCacheIds.splice(index2, 1), delete TextureCache[texture], textureFromCache;
      }
...
var _StateSystem = class _StateSystem2 {
  ...
  updateCheck(func, value) {
    ...
    value && index2 === -1 ? this.checks.push(func) : !value && index2 !== -1 && this.checks.splice(index2, 1);
  }
  /**
...
var TickerPlugin = class {
  ...
  static init(options) {
    options = Object.assign({
      ...
      {
        set(ticker2) {
          this._ticker && this._ticker.remove(this.render, this), this._ticker = ticker2, ticker2 && ticker2.add(this.render, this, UPDATE_PRIORITY.LOW);
        },
        get() {
          return this._ticker;
        }
...
var BufferSystem = class {
  ...
  bindBufferBase(buffer, index2) {
    ...
    if (this.boundBufferBases[index2] !== buffer) {
      ...
      this.boundBufferBases[index2] = buffer, gl.bindBufferBase(gl.UNIFORM_BUFFER, index2, glBuffer.buffer);
    }
  }
  /**
...
var AbstractMultiResource = class extends Resource {
  ...
  addResourceAt(resource, index2) {
    ...
    return resource.valid && !this.valid && this.resize(resource.width, resource.height), this.items[index2].setResource(resource), this;
  }
  /**
...
var ArrayResource = class extends AbstractMultiResource {
  ...
  upload(renderer, texture, glTexture) {
    const { length: length2, itemDirtyIds, items } = this, { gl } = renderer;
...
var _CubeResource = class _CubeResource2 extends AbstractMultiResource {
  ...
  addBaseTextureAt(baseTexture, index2, linkBaseTexture) {
    if (linkBaseTexture === void 0 && (linkBaseTexture = this.linkBaseTexture), !this.items[index2])
      throw new Error(`Index ${index2} is out of bounds`);
    if (!this.linkBaseTexture || baseTexture.parentTextureArray || Object.keys(baseTexture._glTextures).length > 0)
      ...
      baseTexture.target = TARGETS.TEXTURE_CUBE_MAP_POSITIVE_X + index2, baseTexture.parentTextureArray = this.baseTexture, this.items[index2] = baseTexture;
    return baseTexture.valid && !this.valid && this.resize(baseTexture.realWidth, baseTexture.realHeight), this.items[index2] = baseTexture, this;
  }
  /**
   * Upload the resource
   * @param renderer
...
var _Container = class _Container2 extends DisplayObject {
  ...
  addChildAt(child, index2) {
    ...
    return child.parent && child.parent.removeChild(child), child.parent = this, this.sortDirty = true, child.transform._parentID = -1, this.children.splice(index2, 0, child), this._boundsID++, this.onChildrenChange(index2), child.emit("added", this), this.emit("childAdded", child, this, index2), child;
  }
  /**
  ...
  setChildIndex(child, index2) {
    ...
    lib_exports.removeItems(this.children, currentIndex, 1), this.children.splice(index2, 0, child), this.onChildrenChange(index2);
  }
  /**
  ...
  removeChild(...children) {
    if (children.length > 1)
      ...
      const child = children[0], index2 = this.children.indexOf(child);
      if (index2 === -1)
        return null;
      child.parent = null, child.transform._parentID = -1, lib_exports.removeItems(this.children, index2, 1), this._boundsID++, this.onChildrenChange(index2), child.emit("removed", this), this.emit("childRemoved", child, this, index2);
    }
    return children[0];
  }
  /**
  ...
  removeChildAt(index2) {
    ...
    return child.parent = null, child.transform._parentID = -1, lib_exports.removeItems(this.children, index2, 1), this._boundsID++, this.onChildrenChange(index2), child.emit("removed", this), this.emit("childRemoved", child, this, index2), child;
  }
  /**
...
Rectangle2.type = "rect";
Rectangle2.editorConfig = null;
var Torus = class {
  constructor(config) {
    this.x = config.x || 0;
    this.y = config.y || 0;
...
ShapeSpawnBehavior.registerShape(Rectangle2);
...
var LinkedListContainer = class extends Container {
  constructor() {
    super(...arguments);
...
@pixi/particle-emitter/lib/particle-emitter.es.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=@pixi_particle-emitter.js.map
